...
use core::error::bad_resource_id;
use core::error::AnyError;
use core::AsyncRefCell;
use core::BufVec;
use core::CancelHandle;
use core::CancelTryFuture;
use core::JsRuntime;
use core::OpState;
use core::RcRef;
use core::Resource;
use core::ZeroCopyBuf;
...
fn create_js_runtime() -> JsRuntime {
  ...
  runtime.register_op("listen", core::json_op_sync(op_listen));
  runtime.register_op("close", core::json_op_sync(op_close));
  runtime.register_op("accept", core::json_op_async(op_accept));
  runtime.register_op("read", core::json_op_async(op_read));
  runtime.register_op("write", core::json_op_async(op_write));
  runtime
}
...
fn main() {
  ...
  core::v8_set_flags(env::args().collect());
